        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                map2 = new google.maps.Map(document.getElementById('map2'), {
                    center: {lat: answer_obj.coordinates.lat, lng: answer_obj.coordinates.lng},
                    zoom: 13});
                    var marker = new google.maps.Marker({position: {lat: answer_obj.coordinates.lat, lng: answer_obj.coordinates.lng}, map: map2});
